...
sudo dtrace -Z -n 'turtle-io*:::allowed{ trace(copyinstr(arg0)); trace(copyinstr(arg1)); trace(copyinstr(arg2)); trace(arg3); }'  \
               ...
               -n 'turtle-io*:::busy{ trace(copyinstr(arg0)); trace(copyinstr(arg1)); trace(copyinstr(arg2)); trace(arg3); trace(arg4); }'  \
               -n 'turtle-io*:::connection{ trace(arg0); }'  \
               -n 'turtle-io*:::compress{ trace(copyinstr(arg0)); trace(copyinstr(arg1)); trace(copyinstr(arg2)); trace(arg3); }'  \
               -n 'turtle-io*:::compressed{ trace(copyinstr(arg0)); trace(copyinstr(arg1)); trace(copyinstr(arg2)); trace(copyinstr(arg3)); trace(arg4); }'  \
               ...
               -n 'turtle-io*:::route-set{ trace(copyinstr(arg0)); trace(copyinstr(arg1)); trace(arg2); }'  \
