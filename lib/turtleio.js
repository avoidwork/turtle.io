...
const constants = require("constants"),
	...
	levels = require(path.join(__dirname, "lib", "levels")),
	messages = require(path.join(__dirname, "lib", "messages")),
	codes = require(path.join(__dirname, "lib", "codes")),
	regex = require(path.join(__dirname, "lib", "regex")),
