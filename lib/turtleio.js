...
var TurtleIO = function () {
	...
	_createClass(TurtleIO, [{
		...
		value: function register(uri, state) {
			["content-length", "content-encoding", "date", "server", "status", "transfer-encoding", "x-powered-by", "x-response-time", "access-control-allow-origin", "access-control-expose-headers", "access-control-max-age", "access-control-allow-credentials", "access-control-allow-methods", "access-control-allow-headers"].forEach(function (i) {
