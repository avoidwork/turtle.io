...
var TurtleIO = function () {
	...
	_createClass(TurtleIO, [{
		...
		value: function send(req, res) {
			...
			var headers = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : { "content-type": "text/plain" };
...
function factory() {
	...
	var errHandler = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
