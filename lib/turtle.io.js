 ...
 * turtle.io
 *
 * Easy to use webserver with virtual hosts, built on abaaso & node.js.
 *
...
var headers = {
	...
	"Date"                         : "",
	"Server"                       : "turtle.io/0.0.1a abaaso/" + $.version + " node.js/" + process.versions.node.replace(/^v/, "") + " (" + process.platform.capitalize() + " V8/" + process.versions.v8 + ")",
