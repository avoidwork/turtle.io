...
var headers = {
	...
	"Date"                         : "",
	"Last-Modified"                : "",
	"Server"                       : (function () { return ("turtle.io/0.0.10a [abaaso/" + $.version + " node.js/" + process.versions.node.replace(/^v/, "") + " (" + process.platform.capitalize() + " V8/" + process.versions.v8 + ")]"); })(),
