...
var TurtleIO = (function () {
  ...
  */
    ...
    */
			...
			value: function connect(promise) {
				var _this = this;
					...
					if (regex.get.test(method)) {
						...
						fs.unlink(path, function (e) {
							if (e) {
								...
								deferred.resolve(_this.respond(req, res, MESSAGES.NO_CONTENT, CODES.NO_CONTENT, {}));
							}
						});
    ...
    */
			...
			value: function request(promise) {
				var deferred = defer();
					...
					fs.lstat(lpath, function (e, stats) {
						if (e) {
							...
							deferred.resolve(function () {
								return _this.handle(req, res, lpath, req.parsed.href, false, stats);
							});
						} else if (regex.get.test(method) && !regex.dir.test(req.parsed.pathname)) {
							end();
							deferred.resolve(function () {
								return _this.respond(req, res, MESSAGES.NO_CONTENT, CODES.REDIRECT, { Location: (req.parsed.pathname != "/" ? req.parsed.pathname : "") + "/" + req.parsed.search });
							});
						} else if (!regex.get.test(method)) {
							end();
							deferred.resolve(function () {
								return _this.handle(req, res, lpath, req.parsed.href, true);
							});
						} else {
							count = 0;
							...
							array.each(_this.config.index, function (i) {
								...
								fs.lstat(npath, function (e, stats) {
									if (!e && !handled) {
										...
										deferred.resolve(function () {
											return _this.handle(req, res, npath, (req.parsed.pathname != "/" ? req.parsed.pathname : "") + "/" + i + req.parsed.search, false, stats);
										});
    ...
    */
			...
			value: function route(promise) {
				...
				promise.then(function (args) {
					...
					middleware = array.iterator(_this.routes(req.parsed.pathname, req.vhost, method));
					next();
				});
