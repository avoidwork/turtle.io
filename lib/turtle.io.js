...
var TurtleIO = (function () {
  ...
  */
   ...
   */
		...
		value: function decorate(req, res) {
			...
			res.redirect = function (uri) {
				return _this5.respond(req, res, _this5.messages.NO_CONTENT, _this5.codes.FOUND, { location: uri });
			};
   ...
   */
		...
		key: "handle",
		value: function handle(req, res, fpath, url, dir, stat) {
			var _this7 = this;
   ...
   */
		...
		value: function headers(req) {
			var rHeaders = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];
   ...
   */
		...
		value: function start(cfg, err) {
			...
			if (!this.config.headers.server) {
				this.config.headers.server = "turtle.io/4.0.20";
   ...
   */
		...
		key: "watch",
		value: function watch(url, fpath) {
			var _this18 = this;
